...
exports.Add = (req, res, next) => {
    ...
    UserService.Add(formData, (err, user) => {
        if (err) {
            ...
            Email.sendTo(user.email, "Info Management System", "You have registered successfully now you can login with the below email id : " + user.email + " and password : " + password)
            return res.json({
                success: true,
